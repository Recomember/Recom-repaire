...
<body>
 ...
 <h2>新しいRecomemberを登録しよう！</h2>
 <br/>
  <html:errors/>
<s:form>
 <div>
 会話した経験：
  <html:select property="talkStatus" value="${recomemberRegisterDto.talkStatus}">
  <html:option value="なし"/>
  <html:option value="あり"/>
  </html:select>
 </div><br/>
 <div>
  名前：<input type="text" name="memberName" placeholder="例：田中太郎" value="${recomemberRegisterDto.memberName }">
 </div><br/>
 <div>
  電話番号：<input type="text" name="phoneNumber" placeholder="00000000000" value="${recomemberRegisterDto.phoneNumber }">
 </div><br/>
  <div>
  好きな食べ物のジャンル
  <html:select property="favoriteFood" value="${recomemberRegisterDto.favoriteFood}">
   <html:option value="--"/>
 ...
 <div>
  誕生日<br/>
 <html:select property="birthYear" value="${recomemberRegisterDto.birthYear }">
 ...
 <html:select property="birthMonth" value="${recomemberRegisterDto.birthMonth}">
 <html:option value="">--</html:option>
...
<html:option value="12">12</html:option>
 ...
 <html:select property="birthDay" value="${recomemberRegisterDto.birthDay}">
<html:option value="">--</html:option>
<html:option value="1">1</html:option>
<html:option value="2">2</html:option>
<html:option value="3">3</html:option>
...
<html:option value="31">31</html:option>
 ...
 <div>
  ノート<br>
  <html:textarea property="Note" value="${recomemberRegisterDto.note}" />
 </div>
<br/>
<input type="submit" name="showList" value="戻る">
<input type="submit" name="registerConfirm" value="登録確認">
</s:form>
</section>
